async function main() {
    ...
    let approvalTx = await usdc.approve(limitOrders.address, '115792089237316195423570985008687907853269984665640564039457584007913129639935');
    ...
    //==================================================================================================================
    //
    //  TEST ORDER CREATION AND LIQUIDATION - AFTER ENABLING REFUNDS
    //
    //==================================================================================================================
    // ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
    //==================================================================================================================
    ...
    approvalTx = await weth.approve(limitOrders.address, BNB_AMOUNT);
    approvalTxReceipt = await approvalTx.wait();
    console.log(approvalTxReceipt)
    ...
    //==================================================================================================================
    //
    //  TEST ORDER CREATION AND LIQUIDATION - AFTER ENABLING PROTOCOL FEE
    //
    //==================================================================================================================
    // ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
    //==================================================================================================================
