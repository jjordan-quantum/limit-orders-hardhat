async function main() {
    ...
    condition = (routerAddress === ZERO_ADDRESS);
    ...
    condition = (wethAddress === ZERO_ADDRESS);
    ...
    condition = (paymentToken === ZERO_ADDRESS);
    ...
    condition = (stableToken === ZERO_ADDRESS);
    ...
    //==================================================================================================================
    // TEST - check refundsEnabled
    //==================================================================================================================

    testUtils.nextTestUsingCounter("check refundsEnabled");

    //  DEFINE TEST HERE!
    //===================================

    let refundsEnabled = await limitOrders.refundsEnabled();

    condition = (!refundsEnabled);
    ...
    let protocolFeeAmount = await limitOrders.protocolFeeAmount();
    console.log("protocolFeeAmount: " + protocolFeeAmount);

    condition = (!parseInt(protocolFeeAmount));
    ...
    //==================================================================================================================
    // TEST - check max deadline
    //==================================================================================================================

    testUtils.nextTestUsingCounter("check max deadline");

    //  DEFINE TEST HERE!
    //===================================

    let MAX_DEADLINE = await limitOrders.MAX_DEADLINE();

    condition = (parseInt(MAX_DEADLINE) === 2592000);
    ...
    //==================================================================================================================
    // TEST - check averageGasCostPerLiquidation
    //==================================================================================================================

    testUtils.nextTestUsingCounter("check averageGasCostPerLiquidation");
    ...
    //==================================================================================================================
    // TEST - check isAuthorizedOracle
    //==================================================================================================================

    testUtils.nextTestUsingCounter("check isAuthorizedOracle");

    //  DEFINE TEST HERE!
    //===================================

    let isAuthorizedOracle = await limitOrders.isAuthorizedOracle(account);

    condition = (isAuthorizedOracle);
    ...
    routerAddress = await limitOrders.routerAddress();
    ...
    routerSet = await limitOrders.routerSet();
    ...
    wethAddress = await limitOrders.wethAddress();
    ...
    paymentToken = await limitOrders.paymentToken();
    ...
    paymentTokenSet = await limitOrders.paymentTokenSet();
    ...
    stableToken = await limitOrders.stableToken();
    ...
    stableTokenSet = await limitOrders.stableTokenSet();
    ...
    contractSet = await limitOrders.contractSet();
    ...
    testUtils.nextTestUsingCounter("set refundsEnabled");

    //  DEFINE TEST HERE!
    //===================================

    let enableRefundsTx = await limitOrders.enableRefunds();
    let enableRefundsTxReceipt = await enableRefundsTx.wait();

    condition = enableRefundsTxReceipt.status;
    ...
    refundsEnabled = await limitOrders.refundsEnabled();
    ...
    protocolFeeEnabled = await limitOrders.protocolFeeEnabled();
    ...
    //==================================================================================================================
    // TEST - set max deadline
    //==================================================================================================================

    testUtils.nextTestUsingCounter("set max deadline");

    //  DEFINE TEST HERE!
    //===================================

    let updateMaxDeadlineTx = await limitOrders.updateMaxDeadline(2592000+500);
    let updateMaxDeadlineTxReceipt = await updateMaxDeadlineTx.wait();

    condition = updateMaxDeadlineTxReceipt.status;
    ...
    MAX_DEADLINE = await limitOrders.MAX_DEADLINE();

    condition = (parseInt(MAX_DEADLINE) === 2592000+500);
    ...
    //==================================================================================================================
    // TEST - set averageGasCostPerLiquidation
    //==================================================================================================================

    testUtils.nextTestUsingCounter("set averageGasCostPerLiquidation");

    //  DEFINE TEST HERE!
    //===================================

    let updateAverageGasConsumedPerLiquidationTx = await limitOrders.updateAverageGasConsumedPerLiquidation(135000);
    let updateAverageGasConsumedPerLiquidationTxReceipt = await updateAverageGasConsumedPerLiquidationTx.wait();

    condition = updateAverageGasConsumedPerLiquidationTxReceipt.status;
    ...
    averageGasConsumedPerLiquidation = await limitOrders.averageGasConsumedPerLiquidation();

    condition = (parseInt(averageGasConsumedPerLiquidation) === 135000);
